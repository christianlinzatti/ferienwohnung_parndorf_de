// _middleware.js - Vollständige, formatierte Version
...
function normalizePath(p) {
  ...
  // Assets (Bilder, CSS, JS) dürfen KEINEN Slash am Ende bekommen!
...
export async function onRequest(context) {
  ...
  // 1. SYSTEMDATEIEN & ASSETS (Direkt ausliefern)
  // Dies stellt sicher, dass robots.txt und sitemap.xml funktionieren
  const isSystemFile = url.pathname === "/robots.txt" || 
